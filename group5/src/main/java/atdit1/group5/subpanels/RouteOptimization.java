...
/**
 * erzeugt das Panel für die Wegoptimierung. In dieser Klasse sollen später die
 * Funktionalitäten für die Wegoptimierung implementiert werdne. Diese sind NOCH
...
public class RouteOptimization extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Image backgroundImage = Toolkit.getDefaultToolkit().getImage("group5/src/main/resources/images/Wegoptimierung.jpg");
