...
public class NeueAufgabe extends JFrame {
    ...
    public NeueAufgabe(ToDoPanel panel) {
        ...
        ButtonListener listenerAufgabeHinzufuegen = new ButtonListener();
    ...
    class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            JCheckBox aufgabeNeu = new JCheckBox(nameText.getName());
            panel.getAufgabenListe().add(aufgabeNeu);
            panel.getTask_list().add(new Tasks(nameText.getText(), datumAngabe.getText(), beschreibungText.getText(), uhrzeitAngabe.getText(),  prioritätAuswahl.getSelectedItem().toString()));
            panel.addTasks();
            panel.revalidate();
        }
    }
