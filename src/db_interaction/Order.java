...
public class Order {
    ...
    public boolean equals(final Object obj){
        ...
        return Objects.equals(order_id, navIPC.order_id)
                && Objects.equals(firm, navIPC.firm)
                && Objects.equals(stone_type, navIPC.stone_type)
                && Objects.equals(amount, navIPC.amount)
                && Objects.equals(due_date, navIPC.due_date)
                && Objects.equals(phase, navIPC.phase)
                && Objects.equals(price, navIPC.price)
                && Objects.equals(done, navIPC.done)
